...
const RUTA_HISTORIA_ESPANA = {
  ...
  topics: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      learnIntro: 'Tres lecciones para situarte en el origen de la Península: quién llegó primero, qué dejaron en las cuevas y cómo pasaron de cazar a cultivar.',
      image: 'assets/atapuerca.jpg',
      exam: {
      ...
      lessons: [
        {
          ...
          icon: 'skull',
          learnSummary: 'Homo antecessor, Sima de los Huesos y por qué Atapuerca es clave para entender Europa.',
          blocks: [
            {
              type: 'keydate',
              date: '900.000 a.C.',
              title: 'Homo antecessor',
              text: 'En el yacimiento de Gran Dolina se hallaron restos de Homo antecessor, la especie homínida más antigua documentada en Europa occidental.'
            },
            {
              type: 'p',
              text: 'La Sierra de Atapuerca, en Burgos, es el yacimiento prehistórico más importante de Europa. Allí convivieron distintas especies humanas durante cientos de miles de años. Mucho antes de que existiera ningún pueblo, ningún reino, ninguna lengua, ya había humanos contemplando estas tierras.'
            },
            {
              type: 'image',
              src: 'assets/atapuerca.jpg',
              alt: 'Yacimiento arqueológico de Atapuerca',
              caption: 'La Sierra de Atapuerca concentra yacimientos clave para entender la evolución humana en Europa.'
            },
            {
              type: 'timeline',
              title: 'Hitos en Atapuerca',
              events: [
                { date: '900.000 a.C.', title: 'Gran Dolina', text: 'Restos de Homo antecessor, la especie más antigua de Europa occidental.' },
                { date: '430.000 a.C.', title: 'Sima de los Huesos', text: 'Al menos 28 individuos de Homo heidelbergensis, posible ritual funerario.' },
                { date: '2007', title: 'Patrimonio UNESCO', text: 'Atapuerca declarada Patrimonio de la Humanidad por su valor científico único.' }
              ]
            },
            {
              type: 'quote',
              text: 'Atapuerca no es solo un yacimiento: es un archivo de la memoria de la humanidad.',
              author: 'Fundación Atapuerca'
            },
            {
              type: 'tip',
              text: '💡 La Sima de los Huesos es única en el mundo: contiene los restos de al menos 28 individuos, probablemente depositados allí de forma intencionada — uno de los primeros rituales funerarios conocidos de la humanidad.'
            }
          ],
          questions: [
        ...
        },
        {
          ...
          icon: 'image',
          learnSummary: 'Arte paleolítico, Altamira y el patrimonio rupestre del norte peninsular.',
          blocks: [
            {
              type: 'keydate',
              date: '14.000 a.C.',
              title: 'Altamira',
              text: 'En Cantabria, el Homo sapiens pintó bisontes, ciervos y caballos con un realismo que asombró al mundo científico del siglo XIX.'
            },
            {
              type: 'p',
              text: 'Usaban ocre, carbón y grasa animal, y aprovechaban los relieves naturales de la roca para dar volumen a las figuras. España y Francia concentran la mayor colección de arte rupestre paleolítico del planeta.'
            },
            {
              type: 'image',
              src: 'assets/altamira.jpg',
              alt: 'Pinturas rupestres de Altamira',
              caption: 'Las cuevas del norte peninsular guardan uno de los patrimonios artísticos más antiguos de la humanidad.'
            },
            {
              type: 'timeline',
              title: 'Arte rupestre en España',
              events: [
                { date: '14.000 a.C.', title: 'Altamira', text: 'Bisontes y ciervos pintados en Cantabria.' },
                { date: '1879', title: 'Descubrimiento', text: 'Marcelino Sanz de Sautuola documenta las pinturas de Altamira.' },
                { date: '2008', title: 'UNESCO', text: 'Ampliación del Patrimonio Mundial a 17 cuevas del norte de España.' }
              ]
            },
            {
              type: 'quote',
              text: 'Nadie creía que manos tan antiguas pudieran crear belleza tan perfecta.',
              author: 'Crónica del descubrimiento de Altamira'
            },
            {
              type: 'tip',
              text: '💡 Cuando se descubrió Altamira en 1879, los prehistoriadores no creyeron que fueran auténticas: les parecía imposible que un ser «primitivo» pudiera crear algo tan bello. Tardaron décadas en aceptar su autenticidad.'
            }
          ],
          questions: [
        ...
        },
        {
          ...
          icon: 'monument',
          learnSummary: 'Agricultura, dólmenes de Antequera y las culturas del Bronce en el sureste.',
          blocks: [
            {
              type: 'keydate',
              date: '6000 a.C.',
              title: 'Neolítico',
              text: 'Llegan la agricultura, la ganadería y los primeros poblados estables. Los seres humanos empiezan a modificar el territorio de forma permanente.'
            },
            {
              type: 'p',
              text: 'Durante el Calcolítico (Edad del Cobre, ~3000-2000 a.C.) aparecieron los grandes monumentos megalíticos: dólmenes, menhires y cromlechs. Los dólmenes de Antequera — Menga, Viera y El Romeral — son de los más impresionantes de la Península.'
            },
            {
              type: 'image',
              src: 'assets/antequera.jpg',
              alt: 'Dólmenes de Antequera',
              caption: 'Los megalitos son uno de los legados más visibles de la Prehistoria reciente en España.'
            },
            {
              type: 'timeline',
              title: 'De la agricultura al bronce',
              events: [
                { date: '6000 a.C.', title: 'Neolítico', text: 'Agricultura, ganadería y aldeas permanentes.' },
                { date: '3000 a.C.', title: 'Calcolítico', text: 'Grandes dólmenes y menhires por toda la Península.' },
                { date: '2000 a.C.', title: 'Edad del Bronce', text: 'Culturas como la argárica fabrican armas y joyas metálicas.' }
              ]
            },
            {
              type: 'quote',
              text: 'Menga no es solo piedra: es astronomía, esfuerzo colectivo y memoria de una comunidad entera.',
              author: 'Conjunto Arqueológico Dólmenes de Antequera'
            },
            {
              type: 'tip',
              text: '💡 El dolmen de Menga pesa más de 1.000 toneladas y fue construido sin maquinaria. Su orientación apunta a la salida del sol en el solsticio de verano.'
            }
          ],
          questions: [
